...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Electronisasi - Pemanfaatan Asset Universitas Islam Negeri Sultan Syarif Kasim Riau</title>
    ...
    <body class="bg-[#F1F4F5] font-['Poppins']">
        <nav x-data="{ isOpen: false }" class="flex flex-row items-center justify-between max-w-6xl px-5 mx-auto mt-5 mb-20">
            <div class="flex flex-row items-center gap-x-3">
                ...
                <div class="hidden lg:block">
                    <div class="flex flex-col gap-y-1">
                        <h3 class="text-base font-semibold leading-none md:block lg:block text-yellow-500">EMAS</h3>
                        <h3 class="text-base font-semibold leading-none md:block lg:block text-black-500">Elektronisasi Pemanfaatan Asset</h3>
                        <h4 class="text-sm font-semibold leading-none md:block lg:block text-black-500">Universitas Islam
                ...
                <div class="lg:hidden">
                    <div class="flex flex-col gap-y-1">
                        <h3 class="text-base font-semibold leading-none md:block lg:block text-yellow-500">EMAS</h3>
                        <h4 class="text-sm font-semibold leading-none md:block lg:block text-black">UIN SUSKA Riau</h4>
                    </div>
                </div>
            </div>
            <div class="flex flex-row items-center justify-between gap-x-7">
                ...
                <a href="{{ route('login') }}" wire:navigate
                    class="py-2 text-sm font-semibold text-white bg-indigo-950 px-7 rounded-xl hover:bg-green-700">Masuk</a>
        ...
        <section class="max-w-6xl py-5 mx-auto hero mb-40" id="beranda" name="beranda">
            <div class="grid grid-cols-1 md:grid-cols-2 aspect-auto lg:grid-cols-2">
                <div class="flex flex-col justify-center p-5 gap-y-5">
                    <div class="flex flex-col gap-y-0">
                        <h1 class="text-yellow-500 font-['Lobster'] text-9xl leading-10 mb-10">E-MAS</h1>
                        <h2 class="text-black font-['Clash_Display'] text-[32px] leading-nomal">
                            Elektronisasi Pemanfaatan Asset
                        </h2>
                        <h2 class="text-black font-['Clash_Display'] text-2xl leading-nomal">
                            Berkarya <span class="font-['Lobster'] text-yellow-500 font-semibold">Gemilang</span> Berprestasi <span class="font-['Lobster'] text-green-500 font-semibold">Terbilang</span>
                        </h2>
                    ...
                    {{-- <div class="flex flex-row gap-x-5">
                        <a href="https://drive.google.com/file/d/1I2grJD0poamSUSQV8TkiC2X4Wa-l8KRk/view?usp=sharing" target="_blank"
                            class="py-2 text-sm font-semibold text-white rounded-full bg-violet-950 px-7 hover:bg-indigo-700">Surat
                            Keputusan Rektor UIN SUSKA Riau
                        </a>
                        <a href="https://drive.google.com/file/d/1PplRh-hps4XIECTEN7HKBSFs-7QJtI6y/view?usp=sharing" target="_blank"
                            class="py-2 text-sm font-semibold text-white rounded-full bg-violet-950 px-7 hover:bg-indigo-700">Data Kelulusan Penyesuaian UKT
                        </a>
        ...
        <section class="footer w-screen bg-[#080C2E]">
            <div class="grid max-w-6xl py-6 pt-20 mx-auto">
                <div class="flex flex-col px-10 company-logo gap-y-7">
                    <div class="flex flex-row items-center gap-x-3">
                        <img src="{{ asset('assets/images/logo.png') }}" alt="" class="h-[60px]">
                        <div class="flex flex-col gap-y-1">
                            <h3 class="text-xl leading-none text-white md:text-2xl">Bagian Umum Rektorat</h3>
            ...
            <div class="max-w-6xl mx-auto text-center text-[#8D90A8] text-sm pt-6 pb-10 px-10">
                All Rights Reserved • Copyright by PTIPD Universitas Islam Negeri Sultan Syarif Kasim Riau
            </div>
        </section>
    </body>
    @livewireScripts
